	<div class="container">
		...
		<div class="row">
				<div class="col-sm-10">
					    ...
					    <p>If you require more information about this property or you would like to view this property, please contact <strong><?php echo $part->getRentsListinings()->getMemberRegister()->getName(); ?></strong>
					   by email on <strong><a href="mailto:<?php echo $part->getRentsListinings()->getMemberRegister()->getEmail(); ?>"><?php echo $part->getRentsListinings()->getMemberRegister()->getEmail(); ?></a></strong></p>
