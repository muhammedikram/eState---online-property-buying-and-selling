     ...
     <div class="col-md-8"> 
      <h4><?php echo ($this->length($page->items)) ?> Result</h4>
            <?php if ($this->length($page->items) > 0) { ?>
                ...
                <!-- Getting  Image-->
                    <td>
                      <a href="/index/rentpropertydetails/<?php echo $product->getPropertyID(); ?>">
                ...
                <!-- Getting  Type-->
                      ...
                      <!--
                        <td>
                            <?php echo $this->tag->linkTo(array('index/rentpropertydetails/' . $product->getpropertyID(), '<i class="glyphicon glyphicon-edit"></i> View Details', 'class' => 'btn btn-primary')); ?>
