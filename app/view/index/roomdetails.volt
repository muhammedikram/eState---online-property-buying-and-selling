	<div class="container">
			...
			<div class="row">
				<div class="col-md-6">	<br>
					...
					<table class="table table-striped">
							...
							<tr><td><strong>Size: </strong>{{part.getroomsize()}}</td></tr>
							<tr><td><strong>Ready: </strong>{{part.getReady()}}</td></tr>
							<tr><td><strong>Size: </strong>{{part.getroomsize()}}</td></tr>
					</table>
				</div>
			</div>
				...
				<div class="col-md-10">
					...
					<div class="col-md-6">
						...
						echo "<storng>Smoaking</strong>";
						 if ($smoaking == "Yes") { ?>
						 	<img src="/images/tick.png"  width="40" height="40" style="margin-left: 45px !important;" alt="" title="{{ part.getPropertyID()  }}" />
						 <?php 
						 } if ($smoaking != "Yes") { ?> 

							<img src="/images/wrong.png"  width="40" height="40" style="margin-left: 45px;" alt="" title="{{ part.getPropertyID()  }}" />
						<?php  }?>
						<br><br>
						...
						echo "<storng>Pets Allowed</strong>";
						 if ($pets == "Yes") { ?>
						 	<img src="/images/tick.png"  width="40" height="40" style="margin-left: 30px;" alt="" title="{{ part.getPropertyID()  }}" />
						 <?php 
						 } if ($pets != "Yes") { ?> 

							<img src="/images/wrong.png"  width="40" height="40" style="margin-left: 30px;" alt="" title="{{ part.getPropertyID()  }}" />
						<?php  }?>
					</div>
		...
		<div class="row">
				<div class="col-sm-10">
					    ...
					    <p>If you require more information about this property or you would like to view this property, please contact <strong>{{part.getMemberRegister().getName()}}</strong>
					   by email on <strong><a href="mailto:{{part.getMemberRegister().getEmail()}}">{{part.getMemberRegister().getEmail()}}</a></strong></p>

					   <p>Alternatively, you can click contact seller above to send {{part.getMemberRegister().getName()}} message directly from here. </p>
				</div>
			</div>
						...
						<div class="panel panel-default contactpanel">
 				 			<div class="panel-body">
								<div class="contactdetails">
									...
									<h4>{{part.getMemberRegister().getName()}}</h4>
