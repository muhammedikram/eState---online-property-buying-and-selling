	...
	<div class='panel-body'>
		...
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php $v92274464394221791871iterator = $employeesOrders; $v92274464394221791871incr = 0; $v92274464394221791871loop = new stdClass(); $v92274464394221791871loop->length = count($v92274464394221791871iterator); $v92274464394221791871loop->index = 1; $v92274464394221791871loop->index0 = 1; $v92274464394221791871loop->revindex = $v92274464394221791871loop->length; $v92274464394221791871loop->revindex0 = $v92274464394221791871loop->length - 1; ?><?php foreach ($v92274464394221791871iterator as $employeeOrder) { ?><?php $v92274464394221791871loop->first = ($v92274464394221791871incr == 0); $v92274464394221791871loop->index = $v92274464394221791871incr + 1; $v92274464394221791871loop->index0 = $v92274464394221791871incr; $v92274464394221791871loop->revindex = $v92274464394221791871loop->length - $v92274464394221791871incr; $v92274464394221791871loop->revindex0 = $v92274464394221791871loop->length - ($v92274464394221791871incr + 1); $v92274464394221791871loop->last = ($v92274464394221791871incr == ($v92274464394221791871loop->length - 1)); ?>
			
					<tr>
				<td><?php echo $v92274464394221791871loop->index; ?></td>
